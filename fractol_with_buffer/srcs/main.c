...
/*   Updated: 2022/02/10 14:53:07 by egiacomi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	window_init(t_data *data)
{
	...
	data->bpp = data->img.bpp;
	data->line_len = data->img.line_len;
...
int	main(int ac, char **av)
{
	...
	data->buffer = malloc(sizeof(char) * WIN_W * WIN_H + 1);
	if (data->buffer == NULL)
		ft_error(data, "malloc buffer error");
